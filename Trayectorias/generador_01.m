...
q1f=2;       % estos valores son para probar las gráficas de las posiciones y velocidades
q2i=0;       % luego se hará una función generador_02.m donde entre el vector definido de los q´s
q2f=pi;
q3i=0;       % luego se hará una función generador_02.m donde entre el vector definido de los q´s
q3f=pi/2;
qi=[q1i q2i q3i];
qf=[q1f q2f q3f];
...
h=0.5; % es el paso de la iteraccion 
taux=0; % es el tiempo auxiliar 
i=1;
while taux<=Tmax      % Taux guarda el avance 
    q(:,i)=qi+w*taux; % es la ecuación de q en este caso las dos, acá cargamos el vector q1 y q2 con los valores de posición calculada
